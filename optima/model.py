...
def runmodel(simpars=None, pars=None, parset=None, progset=None, budget=None, settings=None, start=2000, end=2030, dt=0.2, tvec=None, name=None, uid=None, project=None, data=None, verbose=2):
    ''' 
    ...
    results = Resultset(raw=raw, parset=parset, progset=progset, budget=budget, simpars=simpars, project=project, data=data, domake=True) # Create structure for storing results
    return results
