...
def defaultproject(which='best', addprogset=True, addcostcovdata=True, usestandardcostcovdata=False, addcostcovpars=True, usestandardcostcovpars=False, addcovoutpars=True, verbose=2, **kwargs):
    ...
    ##########################################################################################################################
        ...
        if addcovoutpars:
            ...
            R.addcovoutpar('condcas', ('Clients','F 50+'), {'intercept': (0.2,0.3), 't': 2016.0, 'Condoms':(0.35,0.45)})
            R.addcovoutpar('condcas', ('Clients','F 15-49'), {'intercept': (0.2,0.3), 't': 2016.0, 'Condoms':(0.35,0.45)})
            R.addcovoutpar('condcas', ('M 15-49','FSW'), {'intercept': (0.3,0.35), 't': 2016.0, 'Condoms':(0.45,0.55), 'FSW programs':(0.55,0.65)})
            R.addcovoutpar('condcas', ('M 15-49','F 15-49'), {'intercept': (0.2,0.3), 't': 2016.0, 'Condoms':(0.35,0.45)})
            R.addcovoutpar('condcas', ('M 15-49','F 50+'), {'intercept': (0.2,0.3), 't': 2016.0, 'Condoms':(0.35,0.45)})
            ...
            R.addcovoutpar('condcas', ('M 50+','F 50+'), {'intercept': (0.2,0.3), 't': 2016.0, 'Condoms':(0.35,0.45)})
