...
def defaultprograms(project, addcostcovpars=False, addcostcovdata=False, filterprograms=None):
    ...
    if addcostcovpars:
        Condoms.addcostcovpar({'saturation': 0.7, 'year': 2016.0, 'unitcost': 5})
        SBCC.addcostcovpar({'saturation': 0.6, 'year': 2016.0, 'unitcost': 10})
        STI.addcostcovpar({'saturation': 0.6, 'year': 2016.0, 'unitcost': 17})
        VMMC.addcostcovpar({'saturation': 0.55, 'year': 2016.0, 'unitcost': 20})
        FSW_programs.addcostcovpar({'saturation': 0.9, 'year': 2016.0, 'unitcost': 30})
        MSM_programs.addcostcovpar({'saturation': 0.9, 'year': 2016.0, 'unitcost': 30})
        PWID_programs.addcostcovpar({'saturation': 0.3, 'year': 2016.0, 'unitcost': 30})
        OST.addcostcovpar({'saturation': 0.3, 'year': 2016.0, 'unitcost': 150})
        NSP.addcostcovpar({'saturation': 0.3, 'year': 2016.0, 'unitcost': 15})
        Cash.addcostcovpar({'saturation': 0.3, 'year': 2016.0, 'unitcost': (50,80)})
        PrEP.addcostcovpar({'saturation': 0.3, 'year': 2016.0, 'unitcost': (100,200)})
        HTC.addcostcovpar({'saturation': 0.9, 'year': 2016.0, 'unitcost': (5,10)})
        ART.addcostcovpar({'saturation': 0.99, 'year': 2016.0, 'unitcost': (400,800)})
        PMTCT.addcostcovpar({'saturation': 0.99, 'year': 2016.0, 'unitcost': (100,200)})
