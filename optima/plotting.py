...
from pylab import isinteractive, ioff, ion, figure, plot, close, ylim, fill_between, scatter, gca, subplot, hold, bar
...
def plotallocs(multires=None, which=None, die=True, figsize=(14,10), verbose=2, **kwargs):
    ...
    for plt in range(nallocs):
        ...
        ymax = maximum(ymax, ax.get_ylim()[1])
