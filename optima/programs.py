    ...
    def getpars(self, coverage, t=None, parset=None, results=None, ind=0, perturb=False, die=False, verbose=2):
        ...
        for outcome in outcomes.keys():
            for p in outcomes[outcome].keys():
                ...
                upper = settings.convertlimits(limits=pars[outcome].limits[1], settings=settings) # Upper limit -- have to convert from string to float based on settings for this project
