...
class OptimaSpreadsheet:
    ...
    def generate_ptrans(self):
        ...
        for name in names:
            if name=='Births': current_row = self.emit_matrix_block(name, current_row, self.ref_females_range, self.ref_pop_range)
    ...
    def generate_const(self):
        ...
        ('Disease progression (average years to move)',
            ...
            OptimaFormats.NUMBER),
        ('Treatment recovery on suppressive ART (average years to move)',
        ...
        ('CD4 change due to non-suppressive ART (% per year)',
            ['CD4(500) to CD4(350-500)',
             ...
             'CD4(50-200) to CD4(<50)',
             'CD4(<50) to CD4(50-200)'],
            [0.026, 0.150, 0.100, 0.053, 0.162, 0.117, 0.090, 0.111],
            [0.005, 0.038, 0.022, 0.008, 0.050, 0.032, 0.019, 0.047],
            [0.275, 0.885, 0.870, 0.827, 0.869, 0.686, 0.723, 0.563],
