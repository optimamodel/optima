define ['angular-mocks', 'Source/modules/programs/program-set/program-set-ctrl', 'Source/modules/project/project-api-service',
  'Source/modules/programs/program-set/program-set-modal-service', 'Source/modules/ui/modal/modal-service',
  'Source/modules/user-manager/index', 'Source/modules/common/active-project-service'], ->
  describe 'ProgramSetController in app.programs', ->
    scope = null
    subject = null
