define(
  ['angular', 'jquery', 'underscore', 'jsPDF', './export-helpers-service'],
  function (angular, $, _, JsPdf) {

    'use strict';

    return angular
      .module('app.export-all-charts', ['app.charts.export-helpers'])
        ...
        return {
          ...
          link: function (scope, elem, attrs) {
            ...
            scope.exportAllFigures = function () {
              ...
              $http
                .post(
                '/api/procedure', { name: 'load_result_pngs', args: [resultI]})
                .then(function() {
                  // load graphs
                });
