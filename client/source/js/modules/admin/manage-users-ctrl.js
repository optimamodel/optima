define(['./module', 'angular', 'underscore'], function (module, angular, _) {
  'use strict';
  module.controller('AdminManageUsersController', function ($scope, $http, $modal, $window, info, users, UserManager, modalService) {
    ...
    $scope.deleteUser = function (user) {
      modalService.confirm(function(){
          $http.delete('/api/user/delete/'+user.id).then(function(){
            ...
            $scope.users = _($scope.users).filter(function(u){return u.id!==user.id});
          })
