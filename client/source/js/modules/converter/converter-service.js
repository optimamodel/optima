  ...
  return angular.module('app.converter', [])
    ...
    .service('converter', function () {
      var service = {
        ...
        json2xlsx: export_table_to_excel
      };
      ...
      function download(content, filename, contentType) {
        ...
        // TODO implement cross-browser click emulation
        a.click();
      }
      ...
      function export_table_to_excel(id) {
        ...
        var result = XLSX.write(wb, {bookType: 'xlsx', bookSST: false, type: 'binary'});

        result = new String(result);

        result.download = function () {
          download(s2ab(result), 'Export to XSLX.xlsx', 'application/octet-stream');
        };
