...
## Revision 15
 - Bug fixes: minmoney optimization works again (was skipping base year which it needs), optimization doesn't throw error when fully constrained, scenario FE error with warning
