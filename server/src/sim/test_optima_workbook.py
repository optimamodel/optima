import os
import unittest
from optima_workbook import OptimaWorkbook, SheetRange, TitledRange, make_parameter_range, make_ref_years_range
import xlsxwriter
...
class TestOptimaWorkbook(unittest.TestCase):
  ...
  def test_ref_years_range(self):
    ...
    self.assertEqual(ref_content.row_names, ["='Test Sheet'!$C$3", "='Test Sheet'!$C$4"])
