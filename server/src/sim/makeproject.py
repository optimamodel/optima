...
### Everything after here is the old way of doing things.
### It is left in to make all other run_x.py files beyond run_optima.py continue functioning.
### The old D is hopefully kept non-global throughout the program or we might hit problems...
