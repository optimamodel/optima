...
#            global niter
    ...
    # Further indices for time varying optimisation
    ...
    optalloc, fval, exitflag, output = ballsd(objectivecalc, optimparams, xmin=zeros(nprogs), timelimit=timelimit, verbose=verbose, MaxIter=maxiters-1, sinitial=stepsizes)
