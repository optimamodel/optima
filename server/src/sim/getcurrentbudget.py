def getcurrentbudget(D, alloc=None, randseed=None):
    ...
    for prognumber, progname in enumerate(D.data.meta.progs.short):
        ...
        if randseed>=0: convertedccparams[0][1] = perturb(1,(array(convertedccparams[2][1])-array(convertedccparams[1][1]))/2., randseed=randseed) - 1 + array(convertedccparams[0][1])
