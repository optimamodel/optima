...
from server.webapp.resources.project import (Project, ProjectItem, ProjectInfo, Paramaters, Predefined, ProjectAll, ProjectCopy)
...
api.add_resource(Paramaters, '/api/project/paramaters')
